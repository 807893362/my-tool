...
public class ApmReport {
    ...
    static {
        //dev环境
        // curl -d '{"uid":1,"roomId":1,"userRoomHisId":1,"page":1}' -H 'Content-Type: application/json'https://monitor-stream.pengpengla.com/stream/api/report/list/get
    ...
    /*public static ResultResponse.Result request(String requestUrl, byte[] requestBytes) throws IOException {
        ...
        httpPost.addHeader("remote_addr", "105.71.135.119");
        httpPost.addHeader("x_true_client_ip", "");
//        httpPost.addHeader("x_forwarded_for", "37.106.192.127");
//        httpPost.addHeader("X-Forwarded-For", "37.106.192.127");
        httpPost.addHeader("x_cdn_provider", "");
        httpPost.addHeader("UserAgent", "iOS/appstore version/8.2.5 os/13.6.1 model/iPhoneXR build/825177 feature/0 smd/2021033113180293887ca4306e96a06df70abbb7a85dfd01152a1b3dc968f0 userToken:aO3G2QYF2004ac3a7ZzWzz uid:531830354");
    ...
    public static void streamEventReport(){
        ...
        String path = "/monitor/apm/report";
    /*    MonitorApmReport.Request.Builder builder = MonitorApmReport.Request.newBuilder();
